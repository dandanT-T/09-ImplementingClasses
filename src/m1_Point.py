...
class Point(object):
    ...
    def move_to(self,x,y):
        ...
        self.move_distance_x = self.move_distance_x + a
        self.move_distance_y = self.move_distance_y + b
        self.distance_traveled = self.distance_traveled + math.sqrt(a**2+b**2)

    def move_by(self, dx, dy):
        self.x = self.x + dx
        self.y = self.y + dy
        self.number_of_moves = self.number_of_moves + 1
        self.move_distance_x = self.move_distance_x + dx
        self.move_distance_y = self.move_distance_y + dy
    ...
    def get_distance_from(self,self2):
        Distance = math.sqrt((self.x-self2.x)**2+(self.y-self2.y)**2)
        return (Distance)

    def get_distance_from_start(self):
        return (math.sqrt(self.move_distance_x**2+self.move_distance_y**2))

    def get_distance_traveled(self):
        return (self.distance_traveled)

    def closer_to(self,self2,self3):
        Distance1 = math.sqrt((self.x-self2.x)**2+(self.y-self2.y)**2)
        Distance2 = math.sqrt((self.x-self3.x)**2+(self.y-self3.y)**2)
        if Distance1>Distance2:
            return self3
        else:
            return self2

    def halfway_to(self,self2):
        return Point((self.x+self2.x)/2,(self.y+self2.y)/2)
